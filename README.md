...
- **Languages and Frameworks:** Python (Django, FastAPI, Flask, SQLAlchemy), REST API
- **Databases:** PostgreSQL, SQLite (query optimization), SQL
- **Message Brokers:** Apache Kafka, RabbitMQ (event-driven architecture, background tasks)
- **Tools:** Docker, Git, GitHub, Linux, Bash
- **Additional:** HTML, CSS, JavaScript, Selenium, PyQt6, aiogram
